export let ThirdRender = {
    preload: function (game) {
        game.load.image('thirdRender', 'Assets/Backgrounds/render3.png');
        game.load.image('pergamena', 'Assets/Backgrounds/pergamena3.png');
    ...
    create: function (game) {
        game.add.sprite(0, 0, 'thirdRender');
